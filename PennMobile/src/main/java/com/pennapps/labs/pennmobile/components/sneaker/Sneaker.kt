...
/**
 * Sneaker is a third party replacement for android's native toasts.
 * Original project can be found here: https://github.com/Hamadakram/Sneaker
    ...
    private fun sneakView() {
        ...
        targetView?.let {
            ...
            with(sneakerView) {
                ...
                setIcon(mIconDrawable, Utils.convertToDp(context, mIconSize.toFloat()), mIconColorFilterColor)
