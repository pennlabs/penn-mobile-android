    ...
    val mockPages =
        listOf(
            ...
            WrappedUnit(
                ...
                values =
                    mapOf(
                        "location1" to "Huntsman Hall",
                        "hours1" to "100,863",
                        "location2" to "Weigle",
                        "hours2" to "23,635",
                        "location3" to "Biotech Commons",
                        "hours3" to "23,152",
                    ),
            ),
            WrappedUnit(
            ...
            WrappedUnit(
                ...
                values =
                    mapOf(
                        "questions1" to "7,321",
                        "class1" to "Mathematical Foundations of Computer Science",
                        "classcode1" to "CIS 1600",
                        "questions2" to "5,260",
                        "class2" to "Data Structures and Algorithms",
                        "classcode2" to "CIS 1210",
                        "questions3" to "3,877",
                        "class3" to "Programming Languages and Techniques",
                        "classcode3" to "CIS 1200",
                    ),
            ),
            WrappedUnit(
                id = 7,
                ...
                values =
                    mapOf(
                        "classcode1" to "CBE 4590",
                        "classname1" to "Product and Process Design",
                        "difficulty1" to "4.0",
                        "classcode2" to "BE 3090",
                        "classname2" to "Bioengineering Lab I",
                        "difficulty2" to "3.9",
                        "classcode3" to "LSMP 4210B",
                        "classname3" to "LSM Capstone",
                        "difficulty3" to "3.9",
                    ),
            ),
            WrappedUnit(
